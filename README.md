...
I'll show you how I deployed a React app—which I created using `create-react-app`—to GitHub Pages.

You can visit the deployed app, at [https://huiyingwang0108.github.io/reactjs-homework/](https://huiyingwang0108.github.io/reactjs-homework/).
...
1. **Create an *empty* repository on GitHub.** (2 minutes)
    ...
    * For this tutorial, I'll create a repository named `reactjs-homework`.
...
2. **Create a new React app on your computer.** (5 minutes)
    ...
    ```sh
    $ create-react-app reactjs-uw
    ```
    
    * This is the app you will deploy to GitHub Pages in step 7.
    * I opted to give the app the different name as my GitHub repository (i.e. `reactjs-uw`). However, you can name them differently from one another (e.g. you can name your app `app-123` and your GitHub Repository `repo-456`).
    * This will create a new folder named `reactjs-uw` (or whatever you named your app) on your computer.
...
4. **Add some properties to the app's `package.json` file.** (3 minutes)
    ...
    * At the top level, add a `homepage` property. Define its value to be the string `http://{username}.github.io/{repo-name}`, where `{username}` is your GitHub username, and `{repo-name}` is the name of the GitHub repository you created in step 1. Since my GitHub username is `gitname` and the name of my GitHub repository is `react-gh-pages`, I added the following property:
    ...
    ```js
    //...
    "homepage": "https://huiyingwang0108.github.io/reactjs-homework/"
    ```
...
6. **Add the GitHub repository as a "remote" in your local git repository.** (1 minute)
    ...
    ```
    $ git remote add origin https://github.com/HuiyingWang0108/reactjs-homework.git
    ```
